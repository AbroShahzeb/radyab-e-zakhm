...
export const Dashboard = () => {
  ...
  return (
    <main className="w-full h-dvh bg-surface-2">
      ...
      <div className="lg:flex-row p-6 flex gap-6 flex-col flex-1 h-[calc(100vh-81px-80px)] lg:h-[calc(100vh-81px)] overflow-y-auto">
        <div className="flex flex-col gap-6 flex-1/2">
          ...
          <div className="flex flex-col gap-6 p-6 rounded-xl bg-neutral-50 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700">
            <div className="flex flex-col gap-2">
              <h1 className="text-preset-1 text-primary-text ">
                Start Detecting
              </h1>
